...
# Description
This library allows you to assign any actions performed on the voice command. As voice sources, WinMM libraries are currently available, as a voice to text converter - Wit.ai
