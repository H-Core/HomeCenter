...
namespace HomeCenter.NET.Extensions
{
    ...
    public static class ScreenExtensions
    {
        ...
        public static async Task ShowWindowAsync<T>(this Screen _, IDictionary<string, object>? settings = null)
        {
        ...
        public static async Task<bool?> ShowDialogAsync<T>(this Screen _, IDictionary<string, object>? settings = null)
        {
            var instance = GetInstance(typeof(T));
            if (instance == null)
            {
        ...
        public static async Task ShowWindowAsync(this Screen _, Screen rootModel, object? context = null, IDictionary<string, object>? settings = null)
        {
            await WindowManager.ShowWindowAsync(rootModel, context, settings);
        }

        public static async Task<bool?> ShowDialogAsync(this Screen _, Screen rootModel, object? context = null, IDictionary<string, object>? settings = null)
        {
