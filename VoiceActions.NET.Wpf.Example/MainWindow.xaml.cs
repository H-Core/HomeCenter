...
namespace VoiceActions.NET.Wpf.Example
{
    public partial class MainWindow : IDisposable
    {
        ...
        private Manager<Action> Manager { get; set; } = new Manager<Action>
        {
        ...
        public MainWindow()
        {
            ...
            Manager.Storage["открой диспетчер файлов"] = () => Process.Start("explorer.exe", "C:/");
            Manager.Storage["проверка"] = () => MessageBox.Show("test");
        }
